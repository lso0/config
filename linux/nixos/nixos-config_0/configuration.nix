...
{ imports =
  ...
  i18n.extraLocaleSettings = { LC_ADDRESS = "pl_PL.UTF-8"; LC_IDENTIFICATION = "pl_PL.UTF-8"; LC_MEASUREMENT = "pl_PL.UTF-8"; LC_MONETARY = "pl_PL.UTF-8"; LC_NAME = "pl_PL.UTF-8"; 
    LC_NUMERIC = "pl_PL.UTF-8"; LC_PAPER = "pl_PL.UTF-8"; LC_TELEPHONE = "pl_PL.UTF-8"; LC_TIME = "pl_PL.UTF-8";
  };
  ...
  services.xserver.displayManager.lightdm.enable = true; services.xserver.desktopManager.xfce.enable = true;
  ...
  users.users.wgt0 = { isNormalUser = true; description = "wgt0"; extraGroups = [ "networkmanager" "wheel" ]; packages = with pkgs; [
    #  thunderbird
    ];
  };
  ...
  services.openssh.enable = true; services.openssh.settings.PasswordAuthentication = true; services.openssh.settings.PermitRootLogin = "yes";

  # Add these in your configuration.nix (inside the main attribute set)
  nix = {
